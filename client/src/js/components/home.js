...
export default class Home extends React.Component {
  ...
  componentDidMount() {
    ...
    handleSearch() {
      ...
      this.callApi().then(res => this.setState({getRanking: res, loaded: 3})).catch(err => this.setState({loaded: 4, err: 1}))
    }
    ...
    render() {
      return (<main>
        ...
        <Data getRanking={this.state.getRanking} loaded={this.state.loaded}/>
      </main>)
    }
    // RENDER
  }
